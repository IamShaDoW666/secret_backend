...
app.get("/token", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (username) {
        const response = yield redis_1.redis.get(`subscribe:${username}`);
        if (response) {
...
app.get("/last-online", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { username } = req.query;
    if (username) {
        const response = yield redis_1.redis.hGetAll(`time:${username}`);
        if (response) {
